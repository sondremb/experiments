...
export function octavePerlin(x, y, octaves, persistance) {
    let total = 0;
    let frequency = 1;
    let amplitude = 1;
    let maxValue = 0;
...
export function OctavePerlinGenerator(octaves, persistance) {
    return (x, y) => octavePerlin(x, y, octaves, persistance);
}
